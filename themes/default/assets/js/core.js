...
$(document).ready(function() {
	...
	$('body').on('click', '.invoice_link_pos td:not(:first-child :last-child)', function() {
        $('#myModal').modal({remote: site.base_url + 'sales/modal_view_pos/' + $(this).parent('.invoice_link_pos').attr('id')});
        $('#myModal').modal('show');
        //window.location.href = site.base_url + 'sales/view/' + $(this).parent('.invoice_link').attr('id');
    });
