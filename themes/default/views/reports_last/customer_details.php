                ...
                <div class="table-responsive">
                    <table id="PRData" class="table table-bordered table-hover table-striped table-condensed">
                        ...
                        <tbody>
							...
							$this->db->select("customer_id,customer")
	...
	$(document).ready(function(){
		...
		*/
		...
		$('#excel').on('click', function(e){
			e.preventDefault();
				window.location.href = "<?=site_url('reports/customersReportDetails/0/xls/'.$customer1.'/'.$reference1.'/'.$product_id1.'/'.$from_date1.'/'.$to_date1)?>";
				return false;
		});
		$('#pdf').on('click', function(e){
			e.preventDefault();
				window.location.href = "<?=site_url('reports/customersReportDetails/pdf/0'.$customer1.'/'.$reference1.'/'.$product_id1.'/'.$from_date1.'/'.$to_date1)?>";
				return false;	
		});
	});
</script>
