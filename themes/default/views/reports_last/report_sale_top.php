...
<script>
    $(document).ready(function () {
        var oTable = $('#SlRDatas').dataTable({
            ...
            "aoColumns": [
			{"bSortable": false, "mRender": checkbox},{"mRender": fld},null,null,null,{"bSearchable": false,"mRender": formatQuantity},{"mRender": currencyFormat},{"sClass":"center"}],
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var gtotal = 0, paid = 0, balance = 0, qtotal = 0 ,quantity=0, amount=0;
