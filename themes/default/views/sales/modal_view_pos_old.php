            ...
            <?php if (!$Supplier || !$Customer) { ?>
                <div class="buttons">
                    <div class="btn-group btn-group-justified">
						...
						-->
			<div class="btn-group">
                            <a href="<?= site_url('sales/p_invoice/' . $inv->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('print_invoice') ?>">
                                <i class="fa fa-print"></i>
                                <span class="hidden-sm hidden-xs"><?= lang('print_invoice') ?></span>
                            </a>
                        </div>
                        <div class="btn-group">
                            <a href="<?= site_url('sales/p_invoice_receipt/' . $inv->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('print_receipt') ?>">
                                <i class="fa fa-print"></i>
