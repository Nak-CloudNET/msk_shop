...
<br>
	...
	<div style="width:1050px; margin:0 auto;">
		<div class ="logo" style="text-align:left;width:35%;float:left;">
			<?php if ($logo) {
			?>
					...
					<table class="table table-bordered table-hover table-striped print-table order-table">
						...
						?>
							<tr>
								...
								<!-- <td style="text-align:center; vertical-align:middle; width:100px;"><?= $this->erp->formatMoney($row->net_unit_price); ?></td> -->
								<td style="text-align:center; vertical-align:middle; width:100px;"><?= $row->subtotal!=0?$this->erp->formatMoney($row->unit_price):$free; ?></td>
								<?php
								if ($Settings->tax1) {
								...
								if ($Settings->product_discount && $inv->product_discount != 0) {
									echo '<td style="width: 100px; text-align:center; vertical-align:middle;">' . ($row->discount != 0 ? '<small>(' . $row->discount . ')</small> ' : '') . $this->erp->formatMoney($row->item_discount) . '</td>';
								}
								?>
								<td style="text-align:center; vertical-align:middle; width:120px;"><?= $row->subtotal!=0?$this->erp->formatMoney($row->subtotal):$free; ?></td>
							</tr>
							<?php
							$r++;
						endforeach;
						...
						<?php if ($inv->grand_total != $inv->total) { ?>
							<tr>
								...
								<td colspan="<?= $tcol; ?>"
									style="text-align:center; vertical-align:middle; padding-right:10px;"><?= lang(" Total"); ?>
								</td>
								<?php
								if ($Settings->tax1) {
								...
								?>
								<td style="text-align:center; vertical-align:middle;padding-right:10px; vertical-align:middle;"><?= $this->erp->formatMoney($inv->total + $inv->product_tax); ?></td>
							</tr>
						<?php } ?>
...
?>
						<td colspan="<?=$cols?>"  rowspan="<?=$ro?>"><div style="font-size:14px;margin-top:20px;"><?=$biller->invoice_footer;?></div></td>
							<td 
								style="text-align:center; vertical-align:middle; font-weight:bold;"><?= lang(" Grand_Total"); ?>
							</td>
							<td style="text-align:center; vertical-align:middle; padding-right:10px; font-weight:bold; padding-top:20px;"><?= $this->erp->formatMoney($inv->grand_total); ?></td>
						</tr>
						<tr>
							<td 
								style="text-align:center; vertical-align:middle; font-weight:bold;"><?= lang(" Paid"); ?>
							</td>
							<td style="text-align:center; vertical-align:middle;font-weight:bold; padding-top:20px;"><?= $this->erp->formatMoney($inv->paid); ?></td>
						</tr>
						<tr>
							<td
								style="text-align:center; vertical-align:middle; font-weight:bold;"><?= lang(" Balance"); ?>
							</td>
							<td style="text-align:center; vertical-align:middle; font-weight:bold; padding-top:20px;"><?= $this->erp->formatMoney($inv->grand_total - $inv->paid); ?></td>
						</tr>
		...
		<tr>
			...
			<?php if($check==1){ ?>
				<input type="checkbox" name="check" id="check" checked="checked">&nbsp &nbsp
