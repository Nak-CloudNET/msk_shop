...
<br>
	<table class="table-responsive" width="1050px" border="0" cellspacing="0" style="margin:auto;">
		...
		<tr>
			<td width="20%" align="center" style="padding-top:5px;">
				<?php if($title==1){?>
				<div style="padding-left:50px;font-family:'Arial'; font-size:25px;font-weight:bold;text-align:left;"><b><?= $title?lang("升鸿旅行社"):"" ?></b></div>
				<?php }else{ ?>
					<div style="font-family:'Arial'; font-size:20px;"><b><?= lang(""); ?></b></div>
				<?php } ?>
			</td>
			<td colspan="5" width="80%" align="center" style="padding-top:5px;padding-right:200px;">
