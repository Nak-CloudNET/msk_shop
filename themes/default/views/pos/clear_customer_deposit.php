...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("pos/clear_customer_deposit/" . $inv->id, $attrib); ?>
                        ...
                        <div style="float:left;width:100%;">
                            <div class="form-group">
                                <div class="input-group">  
                                    <?= form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $reference_no), 'class="form-control tip refer_o" id="reference_no" required="required"'); ?>
                                    <input type="text" name="reference_no_o" style="display:none;" readonly class="form-control refer" id="reference_no_o" value="<?=$reference_no;?>">
                ...
                <div class="well well-sm well_1">
                    <div class="col-md-12">
						...
						<div class="form-group dp" style="display: none;">
							...
							<input type="hidden" name="customer_id" id="customer_id" value="<?=$inv->customer_id;?>">
							<input type="hidden" name="customer" id="customer" value="<?=$inv->customer;?>">
        ...
        <div class="modal-footer">
            <?php echo form_submit('clear_customer_deposit', lang('clear_customer_deposit'), 'class="btn btn-primary" id="clear_customer_deposit" '); ?>
...
<script type="text/javascript" charset="UTF-8">
    $(document).ready(function () {
		...
		$(document).on('click', '#add_payment_tests', function(){
