	...
	public function getPurchases($warehouse_id = null)
    {
        ...
        <ul class="dropdown-menu pull-right" role="menu">
           ...
           .(($this->Owner || $this->Admin) ? '<li class="edit">'.$edit_link.'</li>' : ($this->GP['purchases-edit'] ? '<li class="edit">'.$edit_link.'</li>' : '')).
			(($this->Owner || $this->Admin) ? '<li class="clear_supplier_deposit">'.$clear_supplier_deposit.'</li>' : ($this->GP['purchases-edit'] ? '<li class="clear_supplier_deposit">'.$clear_supplier_deposit.'</li>' : '')).
...
//generate pdf and force to download
	...
	*********/
    ...
    public function add($purchase_order_id = null, $quote_id = null,$sale_order_id=null)
    {
		...
		$this->form_validation->set_rules('reference_no', $this->lang->line("reference_no"), 'trim|required|is_unique[purchases.reference_no]');
...
*/
    ...
    public function add_expense()
    {
        ...
        $this->form_validation->set_rules('reference_no', $this->lang->line("reference_no"), 'trim|required|is_unique[expenses.reference]');
    ...
    public function add_purchase_order($quote_id = null,$sale_order_id= null)
    {
        ...
        $this->form_validation->set_rules('supplier', $this->lang->line("supplier"), 'required');
		$this->form_validation->set_rules('biller', $this->lang->line("biller"), 'required');
        $this->form_validation->set_rules('reference_no', $this->lang->line("reference_no"), 'trim|required|is_unique[purchases_order.reference_no]');
